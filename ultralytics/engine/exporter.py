...
class Exporter:
    ...
    def export_onnx(self, prefix=colorstr("ONNX:")):
        ...
        if dynamic:
            # Keep dynamic batch only. Spatial dimensions stay fixed to avoid unsupported adaptive-pooling export paths.
            dynamic = {"images": {0: "batch"}}  # shape(1,3,640,640), dynamic axis: batch
